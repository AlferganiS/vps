...
!(function (window, document, undefined) {
    ...
    function injectElementWithStyles(A, e, t, n) {
        var r,
            ...
            s = createElement("div"),
            l = getBody();
        if (parseInt(t, 10)) for (; t--; ) (i = createElement("div")), (i.id = n ? n[t] : a + (t + 1)), s.appendChild(i);
        return (
            ...
            (s.id = a),
            l.fake && ((l.style.background = ""), (l.style.overflow = "hidden"), (d = docElement.style.overflow), (docElement.style.overflow = "hidden"), docElement.appendChild(l)),
            (o = e(s, A)),
            l.fake ? (l.parentNode.removeChild(l), (docElement.style.overflow = d), docElement.offsetHeight) : s.parentNode.removeChild(s),
            !!o
        );
    }
    function fnBind(A, e) {
    ...
    (Modernizr.prototype = ModernizrProto),
        ...
        Modernizr.addTest("history", function () {
            ...
            return (-1 === A.indexOf("Android 2.") && -1 === A.indexOf("Android 4.0")) || -1 === A.indexOf("Mobile Safari") || -1 !== A.indexOf("Chrome") || -1 !== A.indexOf("Windows Phone") || "file:" === location.protocol
    ...
    !(function () {
                ...
                (i = function () {
                    return (
                        ...
                        docElement.contains(s)
                            ? (docElement.contains(a) ? ((d = a.style.cssText), "" !== d ? r("blocked", a) : r(!0, a)) : r("blocked"), void n(s))
                            : ((s = document.body || s), (a = createElement("embed")), (a.type = "application/x-shockwave-flash"), s.appendChild(a), setTimeout(i, 1e3))
                    );
                }),
                    setTimeout(i, 10);
            }
        ...
        Modernizr.addAsyncTest(function () {
            function A(i) {
                ...
                return !d && n > r ? void (e = setTimeout(A, t)) : (o.removeEventListener("playing", A, !1), addTest("videoautoplay", d), void (o.parentNode && o.parentNode.removeChild(o)));
            }
            var e,
                t = 200,
                n = 5,
        ...
        Modernizr.addAsyncTest(function () {
            ...
            function e() {
                d && n.revokeObjectURL(d), i && i.terminate(), a && clearTimeout(a);
            }
            try {
        ...
        Modernizr.addAsyncTest(function () {
            var A,
                ...
                r = "sizes" in n;
            !r && "srcset" in n
                ? ((e = "data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw=="),
    ...
    blacklist
        ...
        testStyles("#modernizr{overflow: scroll; width: 40px; height: 40px; }#" + prefixes.join("scrollbar{width:10px} #modernizr::").split("#").slice(1).join("#") + "scrollbar{width:10px}", function (A) {
    ...
    Modernizr.addTest("getrandomvalues", !!supportsGetRandomValues),
        ...
        Modernizr.addTest("regions", function () {
            ...
            (o.innerText = "M"), (r.style.cssText = "top: 150px; left: 150px; padding: 0px;"), (i.style.cssText = "width: 50px; height: 50px; padding: 42px;"), (i.style[A] = d), r.appendChild(o), r.appendChild(i), docElement.appendChild(r);
            var a,
                s,
            ...
            return (
                ...
                42 == s ? (t = !0) : (docElement.appendChild(n), (l = n.getBoundingClientRect()), (n.style[e] = d), (a = n.getBoundingClientRect()), l.height > 0 && l.height !== a.height && 0 === a.height && (t = !0)),
                (o = i = r = n = undefined),
                t
            );
        }),
    ...
    (url = url && window[url]),
        ...
        (function () {
            ...
            for (var A, e, t = ["Width", "Span", "Fill", "Gap", "Rule", "RuleColor", "RuleStyle", "RuleWidth", "BreakBefore", "BreakAfter", "BreakInside"], n = 0; n < t.length; n++)
                (A = t[n].toLowerCase()), (e = testAllProps("column" + t[n])), ("breakbefore" === A || "breakafter" === A || "breakinside" == A) && (e = e || testAllProps(t[n])), Modernizr.addTest("csscolumns." + A, e);
        })(),
                ...
                function n(A, e) {
                    try {
                        ...
                        return (
                            ...
                            (n.innerHTML = "m" + A + "m"),
                            (d = n.offsetHeight > o),
                            e ? ((n.innerHTML = "m<br />m"), (o = n.offsetWidth), (n.innerHTML = "m" + A + "m"), (a = n.offsetWidth > o)) : (a = !0),
                            d === !0 && a === !0 && (i = !0),
                ...
                function r(A) {
                    try {
                        ...
                        (n.innerHTML = r + A + r),
                            ...
                            t.setSelectionRange ? (t.focus(), t.setSelectionRange(0, 0)) : t.createTextRange && ((e = t.createTextRange()), e.collapse(!0), e.moveEnd("character", 0), e.moveStart("character", 0), e.select());
                        try {
