var CodecDetect =
  ...
  (function CodecDetectIIFE() {
    ...
    function detectVideoSupport() {
      ...
      if (_video) {
        _videoSupport.mpeg4 = _video.canPlayType(
          'video/mp4; codecs="mp4v.20.8"'
        );
        _videoSupport.h264 = _video.canPlayType(
          'video/mp4; codecs="avc1.42E01E, mp4a.40.2"'
        );
        _videoSupport.ogg = _video.canPlayType('video/ogg; codecs="theora"');
        _videoSupport.webm = _video.canPlayType(
    ...
    function detectAudioSupport() {
      ...
      if (_audio) {
        ...
        _audioSupport.oggVorbis = _audio.canPlayType(
